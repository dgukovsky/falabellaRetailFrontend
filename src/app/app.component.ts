...
export class AppComponent {
  ...
  onSubmit() {
    ...
    this.superheroesService.getSuperheroes(this.searchForm.value.name)
    .subscribe((res:any) => {
      this.heroes = res.results;
    });
  }
